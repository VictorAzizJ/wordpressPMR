      ...
      <div className="max-w-3xl">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-3">
          {[
            ...
            <div
              key={title}
              className="rounded-pmr border-4 border-pmr-dark bg-pmr-offwhite p-5 text-center"
            >
              <Icon className="mx-auto h-8 w-8 text-pmr-coral" />
              <h3 className="mt-3 font-bold text-pmr-dark">{title}</h3>
              <p className="mt-2 text-sm text-pmr-charcoal">{text}</p>
            </div>
          ))}
        </div>
