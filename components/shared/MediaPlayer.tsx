      ...
      <div className="relative aspect-video bg-pmr-black">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-pmr-black/40">
          {restricted ? (
            ...
            <>
              <Lock className="h-10 w-10 text-pmr-offwhite" />
              <p className="px-4 text-center text-sm font-bold text-pmr-offwhite">
            ...
            <>
              <button
                type="button"
                className="flex h-16 w-16 items-center justify-center rounded-full border-4 border-pmr-offwhite bg-pmr-coral transition hover:scale-105"
                aria-label={`Play ${title}`}
              >
                <Play className="h-8 w-8 fill-pmr-offwhite text-pmr-offwhite" />
              </button>
