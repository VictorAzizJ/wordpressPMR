export function navTabClass() {
  return "relative inline-flex min-h-11 items-center gap-1 px-3 pb-3 pt-2 text-base font-semibold text-pmr-offwhite transition hover:text-pmr-cream focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pmr-coral/70";
}
